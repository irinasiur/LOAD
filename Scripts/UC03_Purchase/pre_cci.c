# 1 "c:\\load_testing\\load_testing\\scripts\\uc03_purchase\\\\combined_UC03_Purchase.c"
...
# 1 "c:\\load_testing\\load_testing\\scripts\\uc03_purchase\\\\combined_UC03_Purchase.c" 2
...
# 2 "c:\\load_testing\\load_testing\\scripts\\uc03_purchase\\\\combined_UC03_Purchase.c" 2
...
# 3 "c:\\load_testing\\load_testing\\scripts\\uc03_purchase\\\\combined_UC03_Purchase.c" 2
...
# 4 "c:\\load_testing\\load_testing\\scripts\\uc03_purchase\\\\combined_UC03_Purchase.c" 2

# 1 "Action.c" 1
Action()
{
	lr_start_transaction("UC03_Покупка");
	...
	web_submit_data("reservations.pl_2", 
		...
		"Mode=HTML", 
		"ITEMDATA", 
		"Name=outboundFlight", "Value={outFlightVal_1}", "ENDITEM",  
		"Name=numPassengers", "Value=1", "ENDITEM", 
		"Name=advanceDiscount", "Value=0", "ENDITEM", 
		"Name=seatType", "Value={seatType}", "ENDITEM", 
		"Name=seatPref", "Value={seatPref}", "ENDITEM", 
	...
	lr_end_transaction("UC03_Покупка",2);

	return 0;
}
# 5 "c:\\load_testing\\load_testing\\scripts\\uc03_purchase\\\\combined_UC03_Purchase.c" 2
...
# 6 "c:\\load_testing\\load_testing\\scripts\\uc03_purchase\\\\combined_UC03_Purchase.c" 2
